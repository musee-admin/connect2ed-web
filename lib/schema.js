...
export const softwareSchema = {
  ...
  operatingSystem: "Web",
  description:
    "A purpose-built platform for school psychology and special education teams — collaboration, progress tracking, standardised workflows, and secure data management in one place.",
  url: SITE_URL,
